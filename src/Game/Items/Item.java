...
public class Item {
	...
	public static Item stickItem = new Item(Images.blocks[15], "Stick", 2);
	public static Item skullItem = new Item(Images.blocks[17], "Skull", 3);
	public static Item fireRuneItem = new Item(Images.Runes[2],"Fire Rune",4);
