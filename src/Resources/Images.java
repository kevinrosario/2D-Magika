...
public class Images {
	...
	public Images() {
		...
		SpriteSheet enemySheet = new SpriteSheet(Images.loadImage("/Sheets/EnemySheet.png"));
		...
		try {
			...
			blocks[15] = ImageIO.read(getClass().getResourceAsStream("/Blocks/Stick.png"));
			blocks[16] = ImageIO.read(getClass().getResourceAsStream("/Blocks/Bush.png"));
			blocks[17] = ImageIO.read(getClass().getResourceAsStream("/Blocks/Skull.png"));
			...
			Enemy_front[0]= enemySheet.crop(0, 1, width, height);
			Enemy_front[1]= enemySheet.crop(30, 1, width, height);
			Enemy_front[2]= enemySheet.crop(62, 1, width, height);
			Enemy_front[3]= enemySheet.crop(94, 1, 28, height);

			Enemy_left[0]= enemySheet.crop(0, 33, width, height);
			Enemy_left[1]= enemySheet.crop(30, 33, width, height);
			Enemy_left[2]= enemySheet.crop(62, 33, width, height);
			Enemy_left[3]= enemySheet.crop(94, 33, 28, height);

			Enemy_right[0]= enemySheet.crop(0, 65, width, height);
			Enemy_right[1]= enemySheet.crop(30, 65, width, height);
			Enemy_right[2]= enemySheet.crop(62,65, width, height);
			Enemy_right[3]= enemySheet.crop(94,65, 28, height);

			Enemy_back[0]= enemySheet.crop(0, 97, width, height);
			Enemy_back[1]= enemySheet.crop(30, 97, width, height);
			Enemy_back[2]= enemySheet.crop(62, 97, width, height);
			Enemy_back[3]= enemySheet.crop(94, 97, 28, height);
